...
│ 左侧目录                                               │ 右侧目录                                               │ 状态                   │
├────────────────────────────────────────────────────┼────────────────────────────────────────────────────┼──────────────────────┤
│ 📄 changed_file.txt                                 │ 📄 changed_file.txt                                 │ 🔄 修改                 │
│    大小: 1.0 KB                                       │    大小: 2.0 KB                                       │ 大小: 1.0 KB→2.0 KB    │
│    时间: 2024-01-01 10:00:00                          │    时间: 2024-01-01 11:00:00                          │ 时间: 10:00:00→11:00:00 │
│    权限: -rw-rw-r--                                   │    权限: -rw-rw-r--                                   │                      │
├────────────────────────────────────────────────────┼────────────────────────────────────────────────────┼──────────────────────┤
│ 📄 old_file.txt                                      │ -                                                  │ ➖ 删除                 │
│    大小: 512 B                                        │                                                    │ 仅左侧存在                │
